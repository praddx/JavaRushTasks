...
//                result = stock1.get("name").compareTo(stock2.get("name"));
                if  (result == 0) {
                ...
                if (result == 0) {
                    ...
                    if (stock1.containsKey("change")) {
                        ...
                        change1 = (Double) ((double) stock1.get("last") - (double) stock1.get("open"));
                    }

                    if (stock2.containsKey("change")) {
                        change2 = (Double) stock2.get("change");
                    }  else {
                        change2 = (Double) ((double) stock2.get("last") - (double) stock2.get("open"));
                    }
